...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h1 id=\"tableLabel\">Fetch-Data</h1>\n\n<p *ngIf=\"!prediction\"><em>Loading...</em></p>\n\n<div *ngIf=\"prediction\">\n    <canvas id=\"longFormVideos\"></canvas>\n</div>\n");
...
let FetchDataComponent = class FetchDataComponent {
    constructor(http, baseUrl) {
        http.get(baseUrl + 'predictor').subscribe(result => {
            this.prediction = result;
            const canvas = document.getElementById('longFormVideos');
...
module.exports = __webpack_require__(/*! /Users/jpeterson/git/YouSchedule/YouSchedule.Portal/ClientApp/src/main.ts */"./src/main.ts");
